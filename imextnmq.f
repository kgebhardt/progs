      ...
      integer naxes(2)
      character file1*160,file1o*160
      logical simple,extend,anyf

c 1    call qc1('Image ','imext.def',file1)
c      call qi1('Which extension ','imext.def',iext)
c      call savdef
      read *,file1
      read *,iext
      file1o=file1
...
c     $     'imext.def',ispec)
c      call qr2('Region ','imext.def',r1,r2)
      read *,ispec
      read *,r1,r2
      ir1=nint(r1)
      ir2=nint(r2)
c      call qi1('Flip it? (1-yes, 0-no) ','imext.def',iflip)
c      call qi1('Biweight (0) or Avg (1) ','imext.def',isum)
c      call qc1('Output name ','imext.def',file1)
c      call savdef
      read *,iflip
      read *,isum
      read *,file1
...
c - flip it or not
 ...
 966  continue
      ...
      if(ier.ne.0) then
         print *,'Error in output file in imextnmq ',ier
         print *,file1o
         print *,file1
         goto 706
      endif

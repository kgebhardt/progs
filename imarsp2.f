...
c      call savdef
      ...
      call ftgiou(im3,ier)
      iread=0
      call ftopen(im3,file3,iread,iblock,ier)
      if(ier.ne.0) then
         write(*,*) 'Error opening image : ',file3
         goto 706
      endif
      call ftmahd(im3,iext1,ihd,ier)
      ...
      call ftclos(im3,ier)
c      call qr1('Value in 2nd image to cut on: ','imar.def',xcut)
      read *,xcut
